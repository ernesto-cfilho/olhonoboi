"""
Django settings for fazendas project.
...
SECRET_KEY = 'django-insecure-u*=v20g9bki#%(=)h8xs&=wzg@#syus(rp0u#ytaoi6&p)*5up'
...
WSGI_APPLICATION = 'fazendas.wsgi.application'
